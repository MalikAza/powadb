...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::snippets::reorder_snippets,
            commands::snippets::list_snippet_folders,
            commands::snippets::save_snippet_folder,
            commands::snippets::reorder_snippet_folders,
            commands::snippets::delete_snippet_folder,
